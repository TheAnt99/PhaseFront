...
PHASEFRONT_API UClass* Z_Construct_UClass_ACombatEnemySpawner();
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ACombatEnemySpawner_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UCombatActivatable_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemySpawner, ICombatActivatable), false },  // 1916847696
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_Combat_AI_CombatEnemySpawner_h__Script_Phasefront_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACombatEnemySpawner, ACombatEnemySpawner::StaticClass, TEXT("ACombatEnemySpawner"), &Z_Registration_Info_UClass_ACombatEnemySpawner, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACombatEnemySpawner), 4032445569U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_Combat_AI_CombatEnemySpawner_h__Script_Phasefront_680772970(TEXT("/Script/Phasefront"),
	Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_Combat_AI_CombatEnemySpawner_h__Script_Phasefront_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_Combat_AI_CombatEnemySpawner_h__Script_Phasefront_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
