...
PHASEFRONT_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData();
PHASEFRONT_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerTask();
...
class UScriptStruct* FStateTreeGetPlayerInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData, (UObject*)Z_Construct_UPackage__Script_Phasefront(), TEXT("StateTreeGetPlayerInstanceData"));
	}
...
class UScriptStruct* FStateTreeGetPlayerTask::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerTask, (UObject*)Z_Construct_UPackage__Script_Phasefront(), TEXT("StateTreeGetPlayerTask"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Phasefront_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FStateTreeGetPlayerInstanceData::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData_Statics::NewStructOps, TEXT("StateTreeGetPlayerInstanceData"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerInstanceData), 1034027398U) },
		{ FStateTreeGetPlayerTask::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerTask_Statics::NewStructOps, TEXT("StateTreeGetPlayerTask"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerTask), 1122584293U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Phasefront_845738845(TEXT("/Script/Phasefront"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Phasefront_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Phasefront_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
