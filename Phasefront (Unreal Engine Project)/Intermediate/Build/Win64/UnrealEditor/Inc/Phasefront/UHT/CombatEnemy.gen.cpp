...
PHASEFRONT_API UClass* Z_Construct_UClass_ACombatEnemy();
PHASEFRONT_API UClass* Z_Construct_UClass_ACombatEnemy_NoRegister();
PHASEFRONT_API UClass* Z_Construct_UClass_UCombatAttacker_NoRegister();
PHASEFRONT_API UClass* Z_Construct_UClass_UCombatDamageable_NoRegister();
PHASEFRONT_API UClass* Z_Construct_UClass_UCombatLifeBar_NoRegister();
...
struct Z_Construct_UDelegateFunction_Phasefront_OnEnemyDied__DelegateSignature_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_Phasefront_OnEnemyDied__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_Phasefront, nullptr, "OnEnemyDied__DelegateSignature", nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Phasefront_OnEnemyDied__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_Phasefront_OnEnemyDied__DelegateSignature_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UDelegateFunction_Phasefront_OnEnemyDied__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_Phasefront_OnEnemyDied__DelegateSignature_Statics::FuncParams);
	}
...
const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ACombatEnemy_Statics::NewProp_OnEnemyDied = { "OnEnemyDied", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACombatEnemy, OnEnemyDied), Z_Construct_UDelegateFunction_Phasefront_OnEnemyDied__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OnEnemyDied_MetaData), NewProp_OnEnemyDied_MetaData) }; // 2291090648
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ACombatEnemy_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UCombatAttacker_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemy, ICombatAttacker), false },  // 1623819174
	{ Z_Construct_UClass_UCombatDamageable_NoRegister, (int32)VTABLE_OFFSET(ACombatEnemy, ICombatDamageable), false },  // 3392385323
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_Combat_AI_CombatEnemy_h__Script_Phasefront_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACombatEnemy, ACombatEnemy::StaticClass, TEXT("ACombatEnemy"), &Z_Registration_Info_UClass_ACombatEnemy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACombatEnemy), 528810498U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_Combat_AI_CombatEnemy_h__Script_Phasefront_4221519197(TEXT("/Script/Phasefront"),
	Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_Combat_AI_CombatEnemy_h__Script_Phasefront_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_antho_Documents_Unreal_Projects_Phasefront_Source_Phasefront_Variant_Combat_AI_CombatEnemy_h__Script_Phasefront_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// ********** End Registration *********************************************************************
